      ...
      <div class="main-panel">
        ...
        background-color: <?php
            if ($order['Status'] === 'Initiated') {
                ...
                echo '#808080'; // Gray for unknown status
            }
        ?>;">
        <?php echo htmlspecialchars($order['Status']); ?>
                    ...
                    <td><?php echo htmlspecialchars($order['Vehicleno']); ?></td>
                    <td><?php echo htmlspecialchars($order['DriverName']); ?></td>
                    <td>
                            <form method="GET" action="order.php">
                                <input type="hidden" name="id" value="<?php echo $order['id']; ?>">
                               
                                <button type="submit" class="btn btn-secondary"><span class="btn-label"><i class="fa fa-plus"></i>
                        </span>Open</button>
                       </form>
                        </td>
                    </tr>
